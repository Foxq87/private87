...
import 'package:ders/pages/create_event.dart';
import 'package:ders/pages/home.dart';
// import 'package:ders/pages/hours.dart';
            ...
            children: [
              ...
              Expanded(
                child: SfCalendar(
                  ...
                  headerStyle:
                      CalendarHeaderStyle(textStyle: TextStyle(fontSize: 25)),
...
List<Appointment> getAppointments(
    String title, String note, int sHour, int sMinute, int eHour, int eMinute) {
              ...
              children: [
                ...
                TextButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).pop(MeetingDataSource(getAppointments(
                          titleController.text.trim(),
                          noteController.text.trim(),
                          hour[index],
                          minute[index2],
...
// Widget bottomSheet(BuildContext context) => Padding(
//       padding: EdgeInsets.all(15),
//       child: Expanded(
//         child: Column(
//           children: [
...
// Widget picker(BuildContext context) => Stack(children: [
//       Positioned(
//         left: 0,
//         right: 0,
//         top: 57,
